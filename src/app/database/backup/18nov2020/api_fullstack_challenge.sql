...
--
-- Host: 127.0.0.1:3306
-- Tempo de geração: 18-Nov-2020 às 20:42
...
--
-- Banco de dados: `api_fullstack_challenge`
--

-- --------------------------------------------------------

--
-- Estrutura da tabela `jsonproducts`
--

DROP TABLE IF EXISTS `jsonproducts`;
CREATE TABLE IF NOT EXISTS `jsonproducts` (
...
--
-- Extraindo dados da tabela `jsonproducts`
--

INSERT INTO `jsonproducts` (`title`, `type`, `description`, `filename`, `height`, `width`, `price`, `rating`, `id`) VALUES
...
INSERT INTO `products` (`title`, `type`, `rating`, `product_id`, `json`) VALUES
